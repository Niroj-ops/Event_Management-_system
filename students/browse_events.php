...
<div class="page-head">
    <h1>Browse Events</h1>
    <div class="tabs">
        <a class="tab <?= $tab==='upcoming'?'active':'' ?>" href="<?= e(url('/students/browse_events.php?tab=upcoming')) ?>">Upcoming</a>
        <a class="tab <?= $tab==='past'?'active':'' ?>" href="<?= e(url('/students/browse_events.php?tab=past')) ?>">Past</a>
    </div>
</div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?= e($remaining) ?> remaining / <?= e((int)$ev['capacity']) ?>
